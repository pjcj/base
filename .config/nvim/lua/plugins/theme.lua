      ...
      require("catppuccin").setup({
        ...
        custom_highlights = function(col)
          return {
            ...
            DiagnosticDeprecated = { sp = col.peach, undercurl = true },
            DiagnosticError = {},
            DiagnosticHint = {},
            DiagnosticInfo = {},
            DiagnosticUnderlineError = { sp = col.red, undercurl = true },
            DiagnosticUnderlineHint = { sp = col.teal, undercurl = true },
            DiagnosticUnderlineInfo = { sp = col.sky, undercurl = true },
            DiagnosticUnderlineWarn = { sp = col.yellow, undercurl = true },
            DiagnosticUnnecessary = { sp = col.overlay0, undercurl = true },
            DiagnosticWarn = {},
            DiffAdded = { fg = c.rgreen },
            DiffRemoved = { fg = c.red },
            ExtraWhitespace = { bg = c.mred },
            GitSignsCurrentLineBlame = { bg = col.base, fg = c.dorange },
            ...
            LineNr = { fg = c.blue },
            LspReferenceText = { bg = col.overlay0 },
            LspReferenceRead = { bg = c.dgreen, fg = c.lllgreen },
            LspReferenceWrite = { bg = c.mred, fg = c.lllred },
            ...
            SidekickDiffAdd = { bg = c.dgreen, fg = c.lllgreen },
            SidekickDiffContext = { bg = c.base07 },
            SidekickDiffDelete = { bg = c.mred, fg = c.lllred },
            ...
            WinSeparator = { bg = col.base, fg = c.violet },
            Whitespace = { fg = c.red },
