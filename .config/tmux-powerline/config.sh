...
# General {
  ...
  # The theme to use.
  export TMUX_POWERLINE_THEME="pjcj"
...
# macos_notification_count.sh {
  ...
  # sqlite3 -list "/var/folders/_t/d8vmw5xs7dn5bqz65l4t2dv80000gn/0//com.apple.notificationcenter/db/db" 'select * from app_info'
...
# mailcount.sh {
  ...
  export TMUX_POWERLINE_SEG_MAILCOUNT_MAILDIR_INBOX="/Users/pjcj/.mail/inbox/new"
  ...
  export TMUX_POWERLINE_SEG_MAILCOUNT_MAILCHECKRC="/Users/pjcj/.mailcheckrc"
# }
